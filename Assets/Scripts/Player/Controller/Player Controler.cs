...
public partial class @PlayerControler : IInputActionCollection2, IDisposable
{
    ...
    readonly InputActionMap m_Dialogue;
    
    IDialogueActions m_DialogueActionsCallbackInterface;
    
    readonly InputAction m_Dialogue_Forward;
    ...
    public struct DialogueActions
    {
        ...
        public void SetCallbacks(IDialogueActions instance)
        {
            ...
            {
                @Forward.started -= m_Wrapper.m_DialogueActionsCallbackInterface.OnForward;

                @Forward.performed -= m_Wrapper.m_DialogueActionsCallbackInterface.OnForward;
                
                @Forward.canceled -= m_Wrapper.m_DialogueActionsCallbackInterface.OnForward;
            }
