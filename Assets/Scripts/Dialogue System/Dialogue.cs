...
public class Dialogue : ScriptableObject
{
    ...
    [SerializeField] Sprite _speakerPortrait;
    [Tooltip("Sprite que representa a caixa de diálogo.")]
    [SerializeField] Sprite _dialogueBox;
    [Tooltip("Texto do diálogo.")]
    [TextArea][SerializeField] string _speakText;
    [Tooltip("O próxio diálogo.")]
    [SerializeField] Dialogue _nextDialogue;
    public enum Side {[InspectorName("Lado Esquerdo")] Left, [InspectorName("Lado Direito")] Right }
    [Tooltip("Qual o lado que o sprite do personagem irá aparecer.")]
    [SerializeField] Side _protraitSide;
