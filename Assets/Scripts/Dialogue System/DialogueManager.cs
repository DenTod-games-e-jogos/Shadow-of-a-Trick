...
{
    [SerializeField] GameObject _leftDialogueCanvas;
    [SerializeField] GameObject _RightDialogueCanvas;
    Dialogue _dialogue;
    ...
    IEnumerator RunDialogue()
    {
        do
        {
            ...
            {
                if (_endDialogueCanvas != null) _endDialogueCanvas.SetActive(false);
